...
<body>
	<table width="500" cellpadding="0" cellspacing="0" border="1">
		<form action="s21_modify" method="post">
			...
			<tr >
				<td colspan="2"> <input type="submit" value="수정"> &nbsp;&nbsp; <a href="s21_list">목록보기</a> &nbsp;&nbsp; <a href="s21_delete?bId=${contentView.bId}">삭제</a> &nbsp;&nbsp; <a href="s21_replyView?bId=${contentView.bId}">답변</a></td>
			</tr>
		</form>
	</table>
</body>
