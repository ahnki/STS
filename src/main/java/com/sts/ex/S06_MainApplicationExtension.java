...
public class S06_MainApplicationExtension {

	public static void main(String[] args) {
		// TODO Auto-generated method stub

		AnnotationConfigApplicationContext ctx = new AnnotationConfigApplicationContext(S06_ApplicationCTX1.class);
		
		System.out.println("S06_MainApplicationExtendsion.java");
		System.out.println("========================");
